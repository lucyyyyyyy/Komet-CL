...
class Basic(Cog):
    ...
    async def patches(self, ctx):
        ...
        @commands.command(aliases=['exfat'])
    async def exfat(self, ctx):
        """Yeet"""
        await ctx.send("Nintendo\'s exFat driver has been known to corrupt exFat filesystems and homebrew only exaserbates this problem.  Please use guiformat (http://www.ridgecrop.demon.co.uk/index.htm?guiformat.htm) to format your sdcard as fat32.")
